...
struct DeveloperSettingsCard: View {
    ...
    @State private var retentionDays = AppLogger.shared.retentionDays
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                if loggingEnabled {
                    Stepper(
                        ...
                        value: Binding(
                            get: { retentionDays },
                            set: { retentionDays = $0; AppLogger.shared.retentionDays = $0 }),
                        in: 1...7
                    ).font(.system(size: 12)).foregroundStyle(Color.scText)
