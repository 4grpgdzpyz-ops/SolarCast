...
struct APIUsageCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            ForEach(Array(quota.perKey.enumerated()), id: \.element.id) { index, keyStats in
                let isLast = index == quota.perKey.count - 1
                ...
                .padding(.horizontal, 16).padding(.top, 9).padding(.bottom, isLast ? 12 : 9)
